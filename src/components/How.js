  ...
  return (
    <section className="how" data-scroll-section>
      <div className="how_title is-inview" data-scroll="" data-scroll-speed="1.6">
        ...
        <p>
          We take care of everything, you just have to test your skin and apply
          serum.
        </p>
        <div
      ...
      <div className="how_steps">
        <ul>
          <li>
            ...
            <p>
              Use our at-home skin test to formulate your custom serum. Nothing
              to mail back!
            </p>
          </li>
          <li>
            ...
            <p>
              After completing your Skin Health Kit, you’ll see your Skin Report
              and preview the ingredients in your formula.
            </p>
          </li>
          <li>
            <h3>
          ...
          <li>
            ...
            <p>
              Each month, we’ll adapt your formula so it continues to change as
              your skin changes.
            </p>
          </li>
        </ul>
